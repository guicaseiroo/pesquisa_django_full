...
ROOT_URLCONF = 'Pesquisa_Core.urls'
...
WSGI_APPLICATION = 'Pesquisa_Core.wsgi.application'
...
STATIC_ROOT = '/root/pesquisa_django_full/static'
STATICFILES_DIRS = [
...
MEDIA_ROOT = '/root/pesquisa_django_full/media' 